...
var _require = require(".././tmdb"),
    retrieveMovie = _require.retrieveMovie;
...
function deleteData() {
  ...
  movie.remove().then(function (reponse) {
...
function loadData() {
  try {
    ...
    retrieveMovie("5066229b476a9c157a74692454f7661e", "venom", ["videos", "images", "credits"]).then(function (_movie) {
      //Add dummy sesions
